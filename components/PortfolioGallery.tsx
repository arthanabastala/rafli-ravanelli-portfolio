...
const PortfolioGallery: React.FC = () => {
  const smkWorks = [
    { src: '/mq-event-banner.jpg', alt: 'Event Banner for SMK Madinatulquran', title: 'Event Banner' },
    { src: '/mq-instagram-story.jpg', alt: 'Instagram Story design for SMK Madinatulquran', title: 'Instagram Story' },
    { src: '/mq-documentation.jpg', alt: 'Event documentation for SMK Madinatulquran', title: 'Documentation' },
    { src: '/mqfest-banner.jpg', alt: 'MQFest Celebration Event Promotional Poster', title: 'MQFest Banner' }
  ];
    ...
    <Section id="portfolio" className="bg-white">
      <div className="max-w-6xl mx-auto">
        <div className="relative text-center mb-16">
          ...
          <h2 className="relative z-10 text-4xl font-black text-neutral-900 uppercase">Selected Works</h2>
        </div>
        ...
        <div className="mb-24">
          <div className="flex flex-col md:flex-row items-start gap-8 mb-8">
            <div className="md:w-1/3">
              <span className="text-sm font-bold tracking-widest text-primary uppercase mb-2 block">Case Study</span>
              <h3 className="text-3xl font-black text-neutral-900 mb-4 uppercase">PT Marsi (Perfume Brand)</h3>
        ...
        <div className="mb-24">
           <div className="text-center mb-10">
              <span className="text-sm font-bold tracking-widest text-primary uppercase mb-2 block">Institutional Branding</span>
              <h3 className="text-3xl font-black text-neutral-900 uppercase">SMK Madinatulquran</h3>
              <p className="text-neutral-600 font-medium mt-2">Supporting school branding, events, and information delivery.</p>
           </div>
        ...
        <div>
           <div className="text-center mb-10">
              <span className="text-sm font-bold tracking-widest text-primary uppercase mb-2 block">Experimental</span>
              <h3 className="text-3xl font-black text-neutral-900 uppercase">design.ke.team</h3>
              <p className="text-neutral-600 font-medium mt-2">Creative playground for collaborative and experimental visuals.</p>
           </div>
